...
public class MyProfilePage extends BasePage {
    ...
    //dropdownMenu
    @FindBy(xpath= "/html/body/main/header/nav/div/div/div[1]/div[2]/div[3]/div/div/button/i") //не става
    private WebElement dropdown;

    @FindBy (xpath = "/html/body/main/header/nav/div/div/div[1]/div[2]/div[3]/div/div/ul/li[2]/a") //не става
